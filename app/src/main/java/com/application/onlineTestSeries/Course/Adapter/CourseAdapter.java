package com.application.onlineTestSeries.Course.Adapter;
...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.MyViewHolder>implements Filterable {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView CourseName,courseCounts;
        ...
        public MyViewHolder(View view) {
            ...
            courseCounts = view.findViewById(R.id.courseCounts);
    ...
    public CourseAdapter(Context mContext, List<CourseData> CourseList, ContactsAdapterListener listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.courseCounts.setText(String.valueOf(courseData.getTOTAL_CHAPTERS()));
    }
